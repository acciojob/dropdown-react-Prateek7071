...
function App() {
	...
	return (
		<div id="main">
			<FormControl>
				...
				>
					{states.map((state, index) => (
						<MenuItem key={state.name} value={index}>
							{state.name}
						</MenuItem>
					))}
				</Select>
			...
			<FormControl>
				...
				>
					{selectedState.city.map((city, index) => (
						<MenuItem key={city.name} value={index}>
							{city.name}
						</MenuItem>
					))}
				</Select>
			...
			<FormControl>
				...
				>
					{selectedCity.landmarks.map((landmark, index) => (
						<MenuItem key={landmark.name} value={index}>
							{landmark.name}
						</MenuItem>
					))}
				</Select>
			...
			<div id="state-name">
				<Card title={selectedState.name} description={selectedState.description} />
			</div>
			<div id="state-description"></div>

			<div id="city-name">
				<Card title={selectedCity.name} description={selectedCity.description} />
			</div>
			<div id="city-description"></div>

			<div id="landmark-name">
				<Card title={selectedLandmark.name} description={selectedLandmark.description} />
			</div>
